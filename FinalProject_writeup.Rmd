...
# [This is where I stopped editing on Saturday, 12.6.25]
...
bees_only_native
bees_only_nonnative
test <- as.list(bees_only_nonnative)
...
sum(clean_df$bee_species == "Andrena angustitarsata")
sum(clean_df$bee_species == "Andrena hippotes")
sum(clean_df$bee_species == "Andrena perplexa")
sum(clean_df$bee_species == "Andrena salicifloris")
sum(clean_df$bee_species == "Anthidium manicatum") #Not a native bee!
sum(clean_df$bee_species == "Anthophora pacifica")
sum(clean_df$bee_species == "Bombus impatiens")
sum(clean_df$bee_species == "Eucera frater")
sum(clean_df$bee_species == "Halictus  ligatus")
sum(clean_df$bee_species == "Halictus virgatellus")
sum(clean_df$bee_species == "Lasioglossum boreale")
sum(clean_df$bee_species == "Lasioglossum egregium")
sum(clean_df$bee_species == "Lasioglossum kincaidii")
sum(clean_df$bee_species == "Lasioglossum quebecense")
sum(clean_df$bee_species == "Megachile brevis")
sum(clean_df$bee_species == "Osmia nemoris")
sum(clean_df$bee_species == "Sphecodes arvensiformis")
```


```{r}
#I got curious if the native plant/bee interactions had similar
#observation counts:
bees_only_native

sum(clean_df$bee_species == "Agapostemon virescens")
sum(clean_df$bee_species == "Andrena prunorum")
sum(clean_df$bee_species == "Andrena vicina")
sum(clean_df$bee_species == "Dianthidium")
sum(clean_df$bee_species == "Hoplitis") 
sum(clean_df$bee_species == "Lasioglossum buccale")
sum(clean_df$bee_species == "Lasioglossum cordleyi")
sum(clean_df$bee_species == "Lasioglossum cressonii")
sum(clean_df$bee_species == "Lasioglossum nigrum")
sum(clean_df$bee_species == "Lasioglossum occulturn")
sum(clean_df$bee_species == "Lasioglossum ruidosense")
sum(clean_df$bee_species == "Megachile gentilis")
sum(clean_df$bee_species == "Megachile melanophaea")
sum(clean_df$bee_species == "Melissodes metenuus")
sum(clean_df$bee_species == "Melissodes microstictus")
sum(clean_df$bee_species == "Melissodes rivalis")
sum(clean_df$bee_species == "Sphecodes kincaidii")
sum(clean_df$bee_species == "Sphecodes Triepeolus")
