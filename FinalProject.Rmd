...
#of the bee species that were only seen visiting nonnative plants, how many 
#observations were there?
another_test <- bee_native_status[bee_native_status$visits_native == FALSE & bee_native_status$visits_nonnative == TRUE,]
another_test$bee_species
```
