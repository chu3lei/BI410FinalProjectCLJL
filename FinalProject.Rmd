...
#onion family, no common name given: this plant has no range data
coastal_oba$nativePlant[coastal_oba$speciesPlant == "Allium cepa"] <- NA
...
# Arctostaphylos Ã— media
#I can't identify this species to clean the name. I'm going to leave it NA for now
...
```{r}
#populating the new column for each unique plant species
#this cell: genus names beginning with 'D'
